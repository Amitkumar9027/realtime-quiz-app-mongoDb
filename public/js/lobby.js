...
socket.on("gameStartedPlayer", function () {
  window.location.href = `/player/game/?id=${socket.id}&quiz_type=${info.quiz_type}&mcq_p=${info.marks.mcq_p}&mcq_n=${info.marks.mcq_n}&buzzer_p=${info.marks.buzzer_p}&buzzer_n=${info.marks.buzzer_n}&no_mcq=${info.no_mcq}&no_buzzer=${info.no_buzzer}`;
});
